...
urlpatterns = [
    ...
    path('admin-dashboard/all-students/', views.AdminAllStudentsView.as_view(), name='admin_all_students'),
    path('admin-dashboard/all-courses/', views.AdminAllCoursesView.as_view(), name='admin_all_courses'),
    path('admin-dashboard/holidays/', views.AdminHolidayView.as_view(), name='admin_holidays'),
    path('admin-dashboard/holidays/delete/<str:holiday_id>/', views.delete_holiday, name='delete_holiday'),
    ...
    path('calendar/holidays/', views.get_holidays_api, name='get_holidays_api'),
    ...
    path('cancel-request/<str:request_id>/', views.cancel_meeting_request, name='cancel_meeting_request'),
    path('my-meeting-requests/', views.StudentMeetingRequestsView.as_view(), name='student_meeting_requests'),
    ...
    # Event Comments
    path('events/<str:model_label>/<str:object_id>/comments/', views.list_event_comments, name='list_event_comments'),
